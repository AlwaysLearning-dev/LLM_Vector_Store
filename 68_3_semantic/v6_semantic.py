...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.qdrant = QdrantClient(
            url=f"http://{self.valves.QDRANT_HOST}:{self.valves.QDRANT_PORT}"
        )
    ...
    async def on_startup(self):
        ...
        try:
            print(f"Attempting to connect to Qdrant at http://{self.valves.QDRANT_HOST}:{self.valves.QDRANT_PORT}")
            
            # Test basic Qdrant connection first
            health = self.qdrant.health()
