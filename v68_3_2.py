        ...
        try:
            ...
            if result and result[0]:
                for point in result[0]:
                    ...
                    # Advanced matching if requested
                    if advanced_search:
                        # More flexible matching: partial word matches, related terms
                        match_score = sum(
                            1 for term in terms 
            ...
            # If using advanced search, sort by match score
            if advanced_search:
...
Important: The rule details above are critical context for answering the following query.

Query: {query}

Please analyze the rule context and provide a detailed response referencing the specific Sigma rule details."""
